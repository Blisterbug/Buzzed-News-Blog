...
const Navbar = () => {
  ...
  return (
    ...
    bg-gray-100">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-6">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isCategoriesOpen && (
              <ul className="absolute bg-gray-100 shadow-lg p-6 mt-2 rounded-lg space-y-4 z-10 w-40 text-gray-700 font-semibold">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="lg:hidden bg-gray-100 p-4 shadow-md rounded-lg">
          ...
          <div className="mt-4 ">
            <h3 className="text-md font-semibold px-4 pb-4">Categories</h3>
